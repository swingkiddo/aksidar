...
export const usps: USP[] = [
  {
    title: "Производство с 2001 года",
    description:
      "Собственный цех в Санкт-Петербурге. 20 000 тонн продукции в год. Работаем 25 лет.",
    icon: "Factory",
  },
  {
    title: "Сертифицированная продукция",
    description:
      "Декларации соответствия ГОСТ Р, санитарно-эпидемиологические заключения. Весь ассортимент проверен.",
    icon: "BadgeCheck",
  },
  {
    title: "Удобная доставка",
    description:
      "Оперативная доставка по Санкт-Петербургу и в регионы. Собственный автопарк или партнёры.",
    icon: "Truck",
  },
  {
    title: "Индивидуальный подход",
    description:
      "Низкие минимальные партии для старта. Private label. Разработка под ваш бренд.",
    icon: "Handshake",
  },
];

export const values: USP[] = [
  {
