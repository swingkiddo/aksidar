      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="bg-white rounded-xl p-6 border border-green-mist/50"
            >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-ink">Пн–Пт: 9:00–18:00</p>
                  <p className="text-sm text-ink/60">Сб–Вс: выходной</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-ink">г. Москва, ул. Производственная, 15</p>
                  <p className="text-sm text-ink/60">БЦ «Современник», офис 305</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-gradient-to-br from-green-pale to-cream rounded-xl p-6"
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <a
                  ...
                  className="flex items-center justify-center gap-2 p-3 rounded-lg bg-[#25D366] text-white hover:opacity-90 transition-opacity"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 p-3 rounded-lg bg-[#0088cc] text-white hover:opacity-90 transition-opacity"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="bg-white rounded-2xl p-8 border border-green-mist/50"
            >
              <h2 className="font-display text-2xl font-bold text-green-deep mb-6">
                Отправить запрос
              </h2>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-green-mid hover:bg-green-deep text-white h-12"
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <div className="bg-gradient-to-br from-green-mist to-green-pale rounded-2xl p-8 md:p-16 flex flex-col items-center justify-center text-center min-h-[300px]">
            <MapPin className="w-16 h-16 text-green-mid/50 mb-4" />
            <h3 className="font-display text-xl font-semibold text-green-deep mb-2">
              Мы на карте
            </h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-green-mid text-white rounded-lg hover:bg-green-deep transition-colors"
            >
